...
class CompleteRegister extends StatefulWidget {
  ...
  CompleteRegister({Key? key, required this.email}) : super(key: key);
...
class _CompleteRegisterState extends State<CompleteRegister> {
  ...
  void initState() {
    ...
    super.initState();
    emailController.text = widget.email; // Set emailController text with passed email
    ...
    return Scaffold(
      body: SingleChildScrollView(
        child: Column(children: [
          appBarSignInOut(context, "Sign in", "assets/images/LOGOS-02.png"),
